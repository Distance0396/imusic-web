...
import followItem from '@/layout/navbar/components/Follow.vue'
...
<template>
  <div class="navbar">
    <a href="/login/account" class="login" v-if="isLogin === ''">
    ...
    <a
      class="login"
      @click="$router.push(`/user/${userInfo.id}`)"
      :style="{ paddingLeft: isBerth ? '1rem' : '.75rem' }"
      v-else-if="isLogin !== ''"
    >
      <div class="avatar" style="width: 40px; height: 40px; font-size: 20px">
      ...
      >
        ...
        <svg
          @click="logout"
          class="close"
          style="margin-left: auto; min-width: 20px; min-height: 20px"
          viewBox="0 0 1024 1024"
          version="1.1"
          xmlns="http://www.w3.org/2000/svg"
          width="20"
        ...
        >
          <path
            d="M783.92332 467.520619l-108.097715-108.137692 60.295258-60.295259L917.05661 480.023415l30.142632 30.152626-211.078379 211.078378-60.295258-60.345229 108.097715-108.097715H331.024277V467.530613h452.899043z m-197.046463 556.479361H160.712409a85.470752 85.470752 0 0 1-60.485149-25.02558 85.458759 85.458759 0 0 1-25.055563-60.475155V86.080401C75.171697 38.877599 113.429653 0.579666 160.712409 0.579666h426.164448v85.280862h-383.479043a42.600454 42.600454 0 0 0-42.945255 42.305624v768.247342c0 22.896807 19.188943 42.29563 42.945255 42.29563h383.479043v85.290856z m0 0"
          ></path>
        </svg>
      </div>
    </a>
        ...
        <div class="menu">
          ...
          <a @click="$router.push('/community')">
            ...
            >
              ...
              <span class="title active" v-if="!isBerth">社区</span>
            </div>
          </a>
          <followItem />
        </div>
