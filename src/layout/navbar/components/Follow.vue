  ...
  <div class="collect">
    <div class="menu-list">
      ...
      <div class="title" v-if="!isBerth">
        ...
        <button class="item-add" @click="addMusicForm">
          ...
          >
            <path
              d="M992 480H544V32c0-17.7-14.3-32-32-32s-32 14.3-32 32v448H32c-17.7 0-32 14.3-32 32s14.3 32 32 32h448v448c0 17.7 14.3 32 32 32s32-14.3 32-32V544h448c17.7 0 32-14.3 32-32s-14.3-32-32-32z"
              fill=""
            ></path>
          </svg>
        </button>
    ...
    <div class="collect-content">
      <div
        ...
        v-if="
          isLogin === '' ||
          this.userFollow.albumList.length === 0 ||
          this.userFollow.singerList.length === 0 ||
          this.userFollow.musicFormList.length === 0
        "
      >
        <span>创建你的第一个歌单</span>
