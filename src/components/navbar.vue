  ...
  <div class="navbar">
    ...
    <div class="scrollbar">
      <div class="scrollbar-container">
        <div class="menu">
          <a href="/#/home">
            <div class="menu-item " :class="{activeItem : '/home' === $route.path}">
          ...
          <a href="/#/explore">
            <div class="menu-item" :class="{activeItem : '/explore' === $route.path}">
              <span class="icon">
            ...
            <div class="menu-list">
              <div class="title">创建的歌单
                <button class="item-add">
                  <span>
                    <svg class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" width="14" height="14"><path d="M992 480H544V32c0-17.7-14.3-32-32-32s-32 14.3-32 32v448H32c-17.7 0-32 14.3-32 32s14.3 32 32 32h448v448c0 17.7 14.3 32 32 32s32-14.3 32-32V544h448c17.7 0 32-14.3 32-32s-14.3-32-32-32z" fill="" ></path></svg>
                  </span>
                </button>
              </div>
              <span class="drop-down">
               <svg class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" width="14" height="14"><path d="M512 657.28l377.6-377.6a40.32 40.32 0 0 1 58.24 0 41.6 41.6 0 0 1 0 58.24l-406.4 406.4a40.32 40.32 0 0 1-58.24 0L76.16 337.92A40.32 40.32 0 0 1 64 308.48a39.04 39.04 0 0 1 12.16-28.8 41.6 41.6 0 0 1 58.24 0z" fill="#445365" ></path></svg>
              </span>
            </div>
          </div>
          <div>
