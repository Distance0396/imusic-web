  ...
  <div class="music-form" v-title data-title="歌单详情">
    ...
    <div class="head">
      <div
        ...
        :style="{ 'background-color': musicForm?.color }"
      ></div>
      ...
      <div class="album-detail">
        ...
        <span style="margin-top: 10px">
          {{ musicForm?.architect }} · {{ musicList?.length }}首歌曲
        </span>
      </div>
    </div>
    <div class="context">
          ...
          <div v-if="musicForm.architectId === this.userInfo.id">
            <span>
              <i
                ...
                class="iconfont icon-xiugai icon"
              />
            </span>
            <el-popconfirm title="确定此歌单删除吗？" @confirm="delPlaylist">
              <i
                slot="reference"
                style="font-size: 30px"
                class="iconfont icon-jianpanshouqi icon"
              />
            </el-popconfirm>
          </div>
        </ActionBar>
      ...
      <div class="musicList">
        <ContextMenu :menu="menu" @select-menu="pickMenu" ref="contextMenu">
          <MusicItem
            ...
            <div style="padding: 5px; display: flex; align-items: center">
              ...
              >
                <img
                  ...
                  :src="selectMusic?.image || musicForm?.image"
                  alt=""
                />
              </div>
              <div
