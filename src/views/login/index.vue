...
<template>
  <div class="login">
    <svg style="position: absolute; " class="icon" width="100vw" height="100vh" viewBox="0 0 503 115" fill="none" xmlns="http://www.w3.org/2000/svg">
...
.login{
  ...
  .login-box{
    ...
    @include respond-to('tv'){
      ...
      .workspace{
        width: 30vw;
        ::v-deep .account-box, ::v-deep .email-box{
