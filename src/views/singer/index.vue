    ...
    <div class="main">
      <div class="background">
        <div
          class="image public"
          :style="{
            backgroundImage: `linear-gradient(var(--gradation-color) 0, rgba(0, 0, 0, 0.4) 0),
          url(${singer.image})`,
          }"
        ></div>
            ...
            >
              <div v-if="musicList.length > 0" class="cont-hot-music">
                ...
                <div class="target">
                  ...
                  >
                    <MusicItem
                      v-for="(item, index) in musicList.slice(
                        0,
                        this.controlMusicNumber
                      )"
                      :key="item.id"
                      :index="index + 1"
                      :music="item"
                      ...
                      >
                        ...
                        >
                          <img
                            ...
                            :src="selectMusic?.image || singer?.avatar"
                            alt=""
                          />
                        </div>
                        <div
                ...
                <div class="more">
                  <span
                    v-if="controlMusicNumber === 5"
                    @click="controlMusicNumber = 10"
                  >
                    查看更多
                  </span>
